...
insert into review(id, rating, description, course_id) values (5002, 'FOUR', 'Wonderful course', 1001);
insert into review(id, rating, description, course_id) values (5003, 'FIVE', 'Awesome course', 1003);
